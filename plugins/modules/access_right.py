...
class AccessRight(BluecatModule):
    def __init__(self):
        self.module_args = dict(
            ...
            admin_event_right=dict(type='str', choices=['VIEW', 'HIDE', 'FULL'], default='VIEW'),
            admin_log_right=dict(type='str', choices=['VIEW', 'HIDE', 'FULL'], default='VIEW'),
            admin_report_right=dict(type='str', choices=['VIEW', 'HIDE', 'FULL'], default='VIEW'),
